...
flags.DEFINE_string('eval_mode', None,
                            'inference mode')
flags.mark_flags_as_required(['config', 'workdir', 'eval_mode'])
...
def _run_main(argv, *, main):
  ...
  main(rng=rng, config=FLAGS.config, workdir=FLAGS.workdir, writer=writer, eval_mode = FLAGS.eval_mode)
